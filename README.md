...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/weather` | `npm install @voxgig-sdk/weather` |
| Python | `voxgig-sdk-weather` | `pip install voxgig-sdk-weather` |
| PHP | `voxgig-sdk/weather` | `composer require voxgig-sdk/weather` |
| Golang | `github.com/voxgig-sdk/weather-sdk/go` | `go get github.com/voxgig-sdk/weather-sdk/go` |
| Ruby | `voxgig-sdk-weather` | `gem install voxgig-sdk-weather` |
| Lua | `voxgig-sdk-weather` | `luarocks install voxgig-sdk-weather` |
