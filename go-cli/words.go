...
func registerSDKWords(r *eng.Registry, client *sdk.WeatherSDK) {
...
func runOp(client *sdk.WeatherSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
