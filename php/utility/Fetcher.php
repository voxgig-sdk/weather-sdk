...
class WeatherFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WeatherSDK/1.0)';
    ...
    public static function call(WeatherContext $ctx, string $fullurl, array $fetchdef): array
    {
