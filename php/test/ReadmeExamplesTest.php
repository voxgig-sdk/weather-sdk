...
// Weather SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WeatherSDK::test)
...
{
    private const SDK_CLASS = 'WeatherSDK';
    ...
    private const SDK_BASE = 'weather_sdk';
