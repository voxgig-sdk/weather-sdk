...
class WeatherTestRunner
{
    ...
    {
        $live = self::getenv('WEATHER_TEST_LIVE');
        $override = self::getenv('WEATHER_TEST_OVERRIDE');
        ...
        $explain = self::getenv('WEATHER_TEST_EXPLAIN');
...
class_alias('WeatherTestRunner', 'Runner');
class_alias('WeatherHelpers', 'Helpers');
