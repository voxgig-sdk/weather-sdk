...
class WeatherRatelimitFeature extends WeatherBaseFeature
{
    ...
    private function _acquire(WeatherContext $ctx): void
    {
    ...
    private function _track(WeatherContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
