...
class WeatherStreamingFeature extends WeatherBaseFeature
{
    ...
    private function _iterate(WeatherResult $result): \Generator
    {
    ...
    private function _streamable(WeatherContext $ctx): bool
    {
