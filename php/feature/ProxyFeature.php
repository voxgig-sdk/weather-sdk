...
class WeatherProxyFeature extends WeatherBaseFeature
{
    ...
    public function init(WeatherContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WeatherContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
