...
// Weather SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WeatherTestFeature extends WeatherBaseFeature
{
    ...
    public function init(WeatherContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WeatherContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WeatherContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WeatherContext $ctx, $op, $args): array
    {
