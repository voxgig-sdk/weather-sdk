...
// Weather SDK clienttrack feature
...
class WeatherClienttrackFeature extends WeatherBaseFeature
{
    ...
    public function PostConstruct(WeatherContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Weather-SDK';
