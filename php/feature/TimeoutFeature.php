...
class WeatherTimeoutFeature extends WeatherBaseFeature
{
    ...
    private function _with_timeout(WeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WeatherContext $_ctx, float $ms): void
    {
        $client = $this->client;
