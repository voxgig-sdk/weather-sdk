...
class WeatherCacheFeature extends WeatherBaseFeature
{
    ...
    private function _through(WeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
