# Weather SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WeatherSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WeatherSDK(...) and WeatherSDK.test(...) become
#      WeatherSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "weather_sdk"
_SDK_CLASS = "WeatherSDK"
