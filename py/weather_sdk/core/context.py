...
from weather_sdk.core.control import WeatherControl
...
from weather_sdk.core.helpers import get_ctx_prop, to_map
...
class WeatherContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, WeatherResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return WeatherError(code, msg, self)
