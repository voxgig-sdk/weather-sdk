...
from weather_sdk.utility import register

# Load features
from weather_sdk.feature.base_feature import WeatherBaseFeature
from weather_sdk.features import _has_feature, _make_feature
...
class WeatherSDK:
    ...
    def get_utility(self):
        return WeatherUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WeatherSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Weather(self, data=None) -> "WeatherEntity":
        ...
        from weather_sdk.entity.weather_entity import WeatherEntity
