...
The Python SDK for the Weather API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/weather-sdk/releases)) or
...
```
py/
├── weather_sdk.py         -- Main SDK module
