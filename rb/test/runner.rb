...
module WeatherTestRunner
  ...
  def self.env_override(m)
    live = getenv("WEATHER_TEST_LIVE")
    override = getenv("WEATHER_TEST_OVERRIDE")
    ...
    explain = getenv("WEATHER_TEST_EXPLAIN")
    m["WEATHER_TEST_EXPLAIN"] = explain if explain && !explain.empty?
