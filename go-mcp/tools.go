...
func registerTools(server *mcp.Server, client *sdk.WeatherSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather_list",
		Description: "List records from Weather. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather_load",
		Description: "Load a single record from Weather. " +
...
func runOp(client *sdk.WeatherSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WeatherSDK, name string) (sdk.WeatherEntity, error) {
