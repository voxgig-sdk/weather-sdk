...
func (sdk *WeatherSDK) OptionsMap() map[string]any {
...
func (sdk *WeatherSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WeatherSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WeatherSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WeatherSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WeatherSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WeatherSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WeatherSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WeatherSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WeatherSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WeatherSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
