...
from projectname_sdk import WeatherSDK
from projectname_sdk.core.spec import WeatherSpec
from projectname_sdk.core.result import WeatherResult
from projectname_sdk.core.response import WeatherResponse
from projectname_sdk.core.operation import WeatherOperation
from projectname_sdk.core.error import WeatherError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import WeatherBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = WeatherSDK.test(None, None)
        ...
        class TestInitFeature(WeatherBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(WeatherBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = WeatherSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = WeatherSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = WeatherSDK.test(None, setup_opts)
