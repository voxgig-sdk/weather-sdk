...
class WeatherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WeatherTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = WeatherTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = WeatherTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
