...
class WeatherRbacFeature extends WeatherBaseFeature
{
    ...
    private function _required(WeatherContext $ctx): ?string
    {
    ...
    private function _reject(WeatherContext $ctx, string $required): void
    {
    ...
    private function _track(WeatherContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
