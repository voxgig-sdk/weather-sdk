...
class WeatherGraphql
{
    ...
    // equivalent.
    public static function body(WeatherContext $ctx): mixed
    {
    ...
    public static function errors(WeatherContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
