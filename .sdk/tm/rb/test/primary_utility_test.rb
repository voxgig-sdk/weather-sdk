...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = WeatherOmni.make_runner(TEST_JSON_FILE, WeatherSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : WeatherOmni.errify(err)
    end
