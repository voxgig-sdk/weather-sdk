...
|---|---|---|
| `ts/` | @voxgig-sdk/weather-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/weather-sdk \
      --repository voxgig-sdk/weather-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/weather-sdk` shows it, and
`npm trust revoke @voxgig-sdk/weather-sdk --id=<id>` removes it.
