...
import { WeatherSDK, BaseFeature, stdutil } from '../../..'
...
describe('WeatherEntity', async () => {
  ...
  afterEach(liveDelay('WEATHER_TEST_LIVE'))

  test('instance', async () => {
    const testsdk = WeatherSDK.test()
...
function basicSetup(extra?: any) {
  ...
  let client = WeatherSDK.test(options, extra)
