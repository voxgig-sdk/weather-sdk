# Weather TypeScript SDK



The TypeScript SDK for the Weather API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Weather()` — each with a small set of operations (`load`)
...
```ts
import { WeatherSDK } from '@voxgig-sdk/weather-sdk'
...
| `tester(testopts?, sdkopts?)` | `WeatherSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `WeatherSDK.test(testopts?, sdkopts?)` | `WeatherSDK` | Create a test-mode client. |
...
| `client` | `client(): WeatherSDK` | Return the parent SDK client. |
