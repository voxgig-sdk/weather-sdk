...
(0, node_test_1.describe)('WeatherEntity', async () => {
    ...
    // `test.live.delayMs`; only sleeps when WEATHER_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('WEATHER_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.WeatherSDK.test();
        const ent = testsdk.Weather();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.WEATHER_TEST_LIVE;
        ...
        (0, node_assert_1.default)(weather_ref01_data_dt0.id === weather_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let client = __1.WeatherSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['WEATHER_TEST_WEATHER_ENTID'];
    ...
    idmap = env['WEATHER_TEST_WEATHER_ENTID'];
    const live = 'TRUE' === env.WEATHER_TEST_LIVE;
    if (live) {
        client = new __1.WeatherSDK(merge([
    ...
    const setup = {
        ...
        struct,
        data: entityData,
        explain: 'TRUE' === env.WEATHER_TEST_EXPLAIN,
        live,
